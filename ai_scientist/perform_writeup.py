...
"""
    ...
    for _ in range(num_cite_rounds):
        ...
        if done:
            break
        # Loop protection: rounds that keep yielding nothing (no papers /
        # errors / same citation) are a cycle — the guard will ask the user.
        guard.check_repeat("citation-round", (prompt or "None")[:120])
